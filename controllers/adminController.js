...
class AdminController {
  ...
  static async updateUser(req, res) {
    try {
      ...
      // نستبعد أي حقول فارغة أو غير مرغوب فيها من التحديث
  ...
  // ✨ دالة جديدة لإعادة تصفير الإيرادات
  static async resetRevenue(req, res) {
    try {
      await Payment.deleteAll();
      await Enrollment.deleteAll(); // حذف التسجيلات المرتبطة
  ...
  static async getTopStudents(req, res) {
    ...
    static async getRevenueReport(req, res) {
        try {
            ...
            // ✨ 2. استخدام كائن db المستورد مباشرة
